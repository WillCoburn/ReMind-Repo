...
struct MainView: View {
    ...
    var body: some View {
        ...
        .background {
            ...
            .tint(.figmaBlue)
            // This page is intentionally light; keep the system keyboard material in that scheme too.
            ...
            ScrollView(showsIndicators: false) {
                VStack(spacing: usesAccessibilityLayout ? 24 : 18) {
                    ...
                    actionIconActions(count: count, viewportWidth: viewportWidth)
                        ...
                        .padding(.top, 4)
                        .opacity(isEditingEntry ? 0.30 : 1)
                        .allowsHitTesting(!isEditingEntry)
    ...
    private func presentEntryComposer() {
        guard activeHomeSheet == nil else { return }

        if isEditingEntry {
            isEntryEditorFocused = true
            return
        }
...
private struct ReceivedMessageBubble: View {
    ...
    var body: some View {
        Text(Self.softWrappingText(text))
            ...
            .lineLimit(80)
            .fixedSize(horizontal: false, vertical: true)
            .padding(.leading, Self.tailReserve + Self.horizontalTextPadding)
            .padding(.trailing, Self.horizontalTextPadding)
            .padding(.vertical, 13)
    ...
    private static let tailReserve: CGFloat = 16
    private static let horizontalTextPadding: CGFloat = 18
